...
public class DBService {
    ...
    public void instanciaDB(){
        Tecnico t1 = new Tecnico(null, "Victor Icoma", "009.393.200-61","victor.icoma@gmail.com", enconder.encode("gordinho123"));
        t1.addPerfis(Perfil.TECNICO);
        t1.addPerfis(Perfil.ADMIN);
        Tecnico t2 = new Tecnico(null, "Jhon Milles Oliveira", "684.344.850-01","jmoliveira@gmail.com", enconder.encode("123456"));
        t2.addPerfis(Perfil.TECNICO);
        Tecnico t3 = new Tecnico(null, "Roger Guedes", "504.368.110-14","guedesroger@gmail.com", enconder.encode("123456"));
        t3.addPerfis(Perfil.TECNICO);
        Tecnico t4 = new Tecnico(null, "Katarina Ferreira", "612.261.820-97","tataferreira@gmail.com", enconder.encode("123456"));
        t4.addPerfis(Perfil.TECNICO);
        Tecnico t5 = new Tecnico(null, "Yaslane Souza", "936.848.410-48","dandansouza@gmail.com", enconder.encode("123456"));
        t5.addPerfis(Perfil.TECNICO);
        t5.addPerfis(Perfil.ADMIN);
        Tecnico t6 = new Tecnico(null, "Brenda Souza", "820.420.380-24","souzabrubs@gmail.com", enconder.encode("123456"));
        t6.addPerfis(Perfil.TECNICO);

        Cliente c1 = new Cliente(null, "Salazar Sonserina", "172.551.910-02","sa.sonserina@gmail.com",enconder.encode("ofideo123"));
        Cliente c2 = new Cliente(null, "Tony Krisley", "072.198.180-17","tonykrisley@gmail.com", enconder.encode("ofideo1234"));
        Cliente c3 = new Cliente(null, "Gregorio Grifinória", "075.261.600-51","grifinoriagreg@gmail.com", enconder.encode("ofideo1234"));
        Cliente c4 = new Cliente(null, "Lorena Corvinal", "603.780.760-43","corvinallorena@gmail.com", enconder.encode("ofideo1234"));
